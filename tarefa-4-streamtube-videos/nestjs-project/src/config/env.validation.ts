...
export const envValidationSchema = Joi.object({
  ...
  VIDEO_MAX_BYTES: Joi.number().default(10737418240),
  VIDEO_UPLOAD_PART_SIZE: Joi.number().default(10485760),
  VIDEO_WORKER_ENABLED: Joi.string().valid('true', 'false').default('false'),
});
