...
export class VideoNotOwnedException extends DomainException {
  constructor() {
    super('VIDEO_NOT_OWNED', 403, 'Video does not belong to this channel');
  }
}

export class VideoUploadInvalidException extends DomainException {
  constructor() {
    super(
      'VIDEO_UPLOAD_INVALID',
      409,
      'Video upload is not available in its current state',
    );
  }
}
...
export class VideoTooLargeException extends DomainException {
  constructor() {
    super('VIDEO_TOO_LARGE', 400, 'Video exceeds the 10 GiB upload limit');
  }
}
...
export class VideoRangeInvalidException extends DomainException {
  constructor() {
    super('VIDEO_RANGE_INVALID', 416, 'Requested video range is invalid');
  }
}
